...
// subscriptions
app.use(apiEndpoints.SUBSCRIPTIONS_ENDPOINT, require('./routes/subscriptions'));

// get all spread sheets
app.use(
    apiEndpoints.SPREADSHEETS_ENDPOINT,
    authenticate,
    require('./routes/spreadsheets')
);
